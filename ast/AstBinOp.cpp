...
Expression *AstBinOp::get_first() { return e1; }

Expression *AstBinOp::get_second() { return e2; }

binop_type AstBinOp::get_binop_type() { return bt; }
