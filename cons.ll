...
entrypoint:
  ...
  %2 = call %struct.Object* @make_int(i64 3)
  %3 = call %struct.Object* @cons_any(%struct.Object* %1, %struct.Object* %2)
  %4 = call %struct.Object* @cons_any(%struct.Object* %0, %struct.Object* %3)
