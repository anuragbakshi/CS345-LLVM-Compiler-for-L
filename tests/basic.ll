...
entrypoint:
  ...
  %6 = call %struct.Object* @make_int(i64 1)
  %7 = call %struct.Object* @minus_any(%struct.Object* %5, %struct.Object* %6)
  %8 = call %struct.Object* @make_int(i64 7)
  %9 = call %struct.Object* @divide_any(%struct.Object* %7, %struct.Object* %8)
  call void @display_any(%struct.Object* %9)
  ret i32 0
}
