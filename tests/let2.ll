...
@1 = private unnamed_addr constant [2 x i8] c"x\00"
@2 = private unnamed_addr constant [2 x i8] c"x\00"
@3 = private unnamed_addr constant [2 x i8] c"x\00"

define i32 @main() {
entrypoint:
  %0 = call i8* @symboltable_new()
  %1 = call %struct.Object* @make_int(i64 5)
  call void @symboltable_push(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @0, i32 0, i32 0), %struct.Object* %1)
  %2 = call %struct.Object* @make_int(i64 4)
  call void @symboltable_push(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @1, i32 0, i32 0), %struct.Object* %2)
  %3 = call %struct.Object* @symboltable_find(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @2, i32 0, i32 0))
  %4 = call %struct.Object* @symboltable_find(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @3, i32 0, i32 0))
  %5 = call %struct.Object* @times_any(%struct.Object* %3, %struct.Object* %4)
  call void @symboltable_pop(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @1, i32 0, i32 0))
  call void @symboltable_pop(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @0, i32 0, i32 0))
